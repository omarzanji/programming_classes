...
public class DodecahedronList2 {
   ...
   //********BEGIN PROJECT 7 METHODS********
   //***************************************

   /**
    * Method that finds shortest edge.
    *
    * @return tag - used for returning result.
    */
   ...
   /**
    * Method that finds longest edge.
    *
    * @return tag - used for returning result.
    */
   ...
   /**
    * Method that finds smallest volume.
    *
    * @return tag - used for returning result.
    */
   ...
   /**
    * Method that finds largest volume.
    *
    * @return tag - used for returning result.
    */
