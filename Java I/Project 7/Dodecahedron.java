...
public class Dodecahedron { 
   ...
   /**
    * Method that gets count.
    *
    * @return tag - used for returning count.
    */
   ...
   /**
    * Method that resets the count to zero.
    */
   ...
   /**
    * Method that checks if object inputted it a dodecahedron.
    *
    * @param isDod - used for determining object.
    * @return tag - used for returning true or false.
    */
   public boolean equals(Object isDod) {
      if (!(isDod instanceof Dodecahedron)) {
         return false;
      }
      else {
         Dodecahedron d = (Dodecahedron) isDod;
   ...
   /**
    * Method that checks equals method.
    *
    * @return tag - returns zero of type int.
    */
   public int hashCode() {
      int output = 0;
      return output;
