...
// This file used for course 3500 operating system class Homework 3 assignment
...
// whether the job is done and resource, the buffer in this case, is available 
...
// The buffer stores one unit of data, that is, an integer.
int buffer = 0;
