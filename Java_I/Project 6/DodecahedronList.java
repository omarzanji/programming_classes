...
public class DodecahedronList {
   ...
   public DodecahedronList readFile(String fileNameIn) throws IOException {
      ...
      ArrayList<Dodecahedron> dogList = new ArrayList<Dodecahedron>(); 
      String dogListName = "";
      String label = "";
      String color = "";
      double edge = 0;
      ...
      DodecahedronList dodList = new DodecahedronList(dogListName, dList);
      return dodList;
   }
   ...
   public Dodecahedron deleteDodecahedron(String deleteLabel) {
      String deleteLabelIn = deleteLabel.trim().toUpperCase();
      Dodecahedron scanObj;
      Dodecahedron obj = null;
      ...
      for (i = 0; i < dList.size(); i++) {
         ...
         if (trimmed.equals(deleteLabelIn)) {
            obj = dList.get(i);
            remove = dList.indexOf(dList.get(i));
            objFound = true;
            break;
         }
         else {
